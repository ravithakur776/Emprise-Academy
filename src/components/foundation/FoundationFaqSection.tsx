...
import { FoundationFaqItem } from "@/data/foundation";
import { ChevronDown, ArrowRight } from "lucide-react";
import { cn } from "@/lib/utils";

export interface FoundationFaqSectionProps {
  heading?: string;
  subheading?: string;
  faqs: readonly FoundationFaqItem[];
}

export const FoundationFaqSection: React.FC<FoundationFaqSectionProps> = ({
  heading = "Foundation Programme Frequently Asked Questions",
  subheading = "Clear, encouraging answers for students and parents exploring academic foundation coaching at Emprise Academy.",
  faqs,
}) => {
    ...
    <Section variant="default" spacing="lg" id="faqs">
      <Container size="md">
        ...
        <div className="text-center pt-8">
          ...
          >
            <span>Have more questions about Foundation batches? Speak with our academic counsellors</span>
