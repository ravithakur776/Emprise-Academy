...
import { ArrowRight, BookOpen, CheckCircle2, Sparkles, Compass, Lightbulb } from "lucide-react";

export interface FoundationHeroProps {
...
export const FoundationHero: React.FC<FoundationHeroProps> = ({
  breadcrumbs,
  eyebrow,
  h1,
  subheading,
  ...
  primaryCta,
  secondaryCta,
  statsBadge = "★ Classes 8, 9 & 10 • Est. 2011",
}) => {
  return (
            ...
            <div className="rounded-2xl bg-linear-to-b from-slate-800/90 to-slate-900/95 border border-slate-700/80 p-6 sm:p-8 shadow-2xl backdrop-blur-md">
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-white leading-tight">
                      Foundation Academic Culture
                    </h3>
                    <p className="text-[11px] text-slate-400">
                      Mathematics • Science • Mental Ability
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-3 mb-6 text-xs text-slate-300">
                <div className="flex items-start gap-3 p-2.5 rounded-lg bg-white/5 border border-white/5">
                  ...
                  <div>
                    <span className="font-bold text-white block">Concept-First Discovery</span>
                    <span className="text-slate-400">Understand the &apos;why&apos; behind formulas and laws.</span>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-2.5 rounded-lg bg-white/5 border border-white/5">
                  <Compass className="w-4 h-4 text-sky-400 shrink-0 mt-0.5" />
                  <div>
                    <span className="font-bold text-white block">Logical Problem Solving</span>
                    <span className="text-slate-400">Step-by-step reasoning over rote memorization.</span>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-2.5 rounded-lg bg-white/5 border border-white/5">
                  <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0 mt-0.5" />
                  <div>
                    <span className="font-bold text-white block">Readiness, Not Exam Pressure</span>
                    <span className="text-slate-400">Supportive, age-appropriate intellectual growth.</span>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-3 border-t border-slate-700/60 text-center">
                ...
                >
                  Schedule Free Foundation Academic Counselling
                </a>
              </div>
            </div>
          </div>
