...
import { ArrowRight, GraduationCap, ShieldCheck, Compass, Trophy } from "lucide-react";

export interface DirectorsHeroProps {
...
export const DirectorsHero: React.FC<DirectorsHeroProps> = ({
  breadcrumbs,
  eyebrow,
  h1,
  subheading,
    ...
    <section className="relative overflow-hidden bg-linear-to-b from-[var(--brand-primary)] via-[#0D2342] to-[#0A192F] text-white pt-6 pb-12 sm:pt-8 sm:pb-16 lg:pb-20 border-b border-slate-800">
      ...
      <Container size="xl" className="relative z-10 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          {/* Right: Academic Credibility Card */}
          <div className="lg:col-span-5">
            <div className="rounded-2xl bg-linear-to-b from-slate-800/90 to-slate-900/95 border border-slate-700/80 p-6 sm:p-8 shadow-2xl backdrop-blur-md space-y-5">
              <div className="flex items-center gap-3 border-b border-slate-700/60 pb-4">
                <div className="w-10 h-10 rounded-xl bg-[var(--brand-accent)] text-white flex items-center justify-center font-bold">
                  <GraduationCap className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="text-sm font-bold text-white leading-tight">
                    Academic Engineering Leadership
                  </h3>
                  <p className="text-[11px] text-slate-400">
                    Univ. of Derby (UK) • Rolls-Royce & Ford UK • Est. 2011
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-3 text-xs text-slate-300">
                <div className="flex items-start gap-2.5 p-2.5 rounded-lg bg-white/5 border border-white/5">
                  ...
                  <div>
                    ...
                    <span className="text-slate-400">Derivations and proofs taught from fundamental first principles.</span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2.5 p-2.5 rounded-lg bg-white/5 border border-white/5">
                  ...
                  <div>
                    <span className="font-bold text-white block">Direct Classroom Mentorship</span>
                    <span className="text-slate-400">Directors teach and guide students directly in the classroom.</span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2.5 p-2.5 rounded-lg bg-white/5 border border-white/5">
                  ...
                  <div>
                    <span className="font-bold text-white block">15+ Years Mathura Legacy</span>
                    <span className="text-slate-400">Permanent institutional commitment to Mathura&apos;s youth since 2011.</span>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-2 border-t border-slate-700/60 text-center">
                ...
                >
                  Schedule an In-Person Academic Meeting
                </Link>
              </div>
            </div>
          </div>
