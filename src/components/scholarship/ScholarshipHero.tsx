...
import { ArrowRight, Award, ShieldCheck, CheckCircle2, Trophy, HelpCircle } from "lucide-react";
...
export const ScholarshipHero: React.FC<ScholarshipHeroProps> = ({
  breadcrumbs,
  eyebrow,
  h1,
  subheading,
    ...
    <section className="relative overflow-hidden bg-linear-to-b from-[var(--brand-primary)] via-[#0D2342] to-[#0A192F] text-white pt-6 pb-12 sm:pt-8 sm:pb-16 lg:pb-20 border-b border-slate-800">
      ...
      <Container size="xl" className="relative z-10 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          {/* Right Column: Scholarship Principles Card */}
            ...
            <div className="rounded-2xl bg-linear-to-b from-slate-800/90 to-slate-900/95 border border-slate-700/80 p-6 sm:p-8 shadow-2xl backdrop-blur-md space-y-5">
              <div className="flex items-center gap-3 border-b border-slate-700/60 pb-4">
                ...
                <div>
                  <h3 className="text-sm font-bold text-white leading-tight">
                    Merit-Based Academic Support
                  </h3>
                  <p className="text-[11px] text-slate-400">
                    Transparent • Objective • Verified Criteria
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-3 text-xs text-slate-300">
                <div className="flex items-start gap-2.5 p-2.5 rounded-lg bg-white/5 border border-white/5">
                  ...
                  <div>
                    <span className="font-bold text-white block">100% Merit Driven</span>
                    <span className="text-slate-400">Concessions based strictly on test scores and verified board marks.</span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2.5 p-2.5 rounded-lg bg-white/5 border border-white/5">
                  ...
                  <div>
                    <span className="font-bold text-white block">Zero Application Fee for ETSE</span>
                    <span className="text-slate-400">Annual talent search test is completely free to appear.</span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2.5 p-2.5 rounded-lg bg-white/5 border border-white/5">
                  ...
                  <div>
                    <span className="font-bold text-white block">Equal Learning Standards</span>
                    <span className="text-slate-400">All students receive identical classroom lectures and doubt support.</span>
                  </div>
                </div>
              </div>
