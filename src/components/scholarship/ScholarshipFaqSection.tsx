...
import { MAIN_SCHOLARSHIP_DATA, ScholarshipFaqItem } from "@/data/scholarship";
import { ChevronDown, ArrowRight } from "lucide-react";
import { cn } from "@/lib/utils";

export const ScholarshipFaqSection: React.FC = () => {
  const { faqs } = MAIN_SCHOLARSHIP_DATA;
      ...
      <Container size="md">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 space-y-3">
          ...
          <Text variant="body-large" color="muted" align="center">
            Clear, transparent answers regarding eligibility, assessments, and tuition fee concession procedures.
          </Text>
        </div>
