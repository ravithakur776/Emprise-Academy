...
import { ArrowRight, GraduationCap, CheckCircle2, HeartPulse, Zap } from "lucide-react";
    ...
    <section className="relative overflow-hidden bg-linear-to-b from-[var(--brand-primary)] via-[#0D2342] to-[#0A192F] text-white pt-6 pb-12 sm:pt-8 sm:pb-16 lg:pb-20 border-b border-slate-800">
      ...
      <Container size="xl" className="relative z-10 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          {/* Right: Academic Mentorship Rigor Box */}
            ...
            <div className="rounded-2xl bg-linear-to-b from-slate-800/90 to-slate-900/95 border border-slate-700/80 p-6 sm:p-8 shadow-2xl backdrop-blur-md space-y-5">
              ...
              <div className="space-y-3 text-xs text-slate-300">
                <div className="flex items-start gap-2.5 p-2.5 rounded-lg bg-white/5 border border-white/5">
                  <Zap className="w-4 h-4 text-[var(--brand-accent)] shrink-0 mt-0.5" />
                  <div>
                    <span className="font-bold text-white block">Concept-First Pedagogy</span>
                    <span className="text-slate-400">Detailed derivations and proofs from fundamental laws.</span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2.5 p-2.5 rounded-lg bg-white/5 border border-white/5">
                  ...
                  <div>
                    <span className="font-bold text-white block">Daily Doubt Resolution</span>
                    <span className="text-slate-400">Faculty members directly accessible to resolve student queries.</span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2.5 p-2.5 rounded-lg bg-white/5 border border-white/5">
                  ...
                  <div>
                    <span className="font-bold text-white block">Continuous Error Analysis</span>
                    <span className="text-slate-400">Test reviews to turn lost marks into permanent precision.</span>
                  </div>
                </div>
              </div>
