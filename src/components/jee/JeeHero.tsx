...
import { ArrowRight, BookOpen, CheckCircle2, Trophy, GraduationCap } from "lucide-react";

export interface JeeHeroProps {
...
export const JeeHero: React.FC<JeeHeroProps> = ({
  breadcrumbs,
  eyebrow,
  h1,
  subheading,
    ...
    <section className="relative overflow-hidden bg-linear-to-b from-[var(--brand-primary)] via-[#0D2342] to-[#0A192F] text-white pt-6 pb-12 sm:pt-8 sm:pb-16 lg:pb-20 border-b border-slate-800">
      ...
      <Container size="xl" className="relative z-10 space-y-6">
        ...
        <div className="text-slate-400">
          <Breadcrumbs items={breadcrumbs} className="text-slate-300 [&_a]:text-slate-300 [&_a:hover]:text-white [&_span]:text-white" />
        </div>
          ...
          <div className="lg:col-span-5">
            <div className="rounded-2xl bg-linear-to-b from-slate-800/90 to-slate-900/95 border border-slate-700/80 p-6 sm:p-8 shadow-2xl backdrop-blur-md">
              ...
              <div className="space-y-3 mb-6 text-xs text-slate-300">
                <div className="flex items-start gap-3 p-2.5 rounded-lg bg-white/5 border border-white/5">
                  ...
                  <div>
                    ...
                    <span className="text-slate-400">Derivations and proofs from first principles.</span>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-2.5 rounded-lg bg-white/5 border border-white/5">
                  <Trophy className="w-4 h-4 text-amber-400 shrink-0 mt-0.5" />
                  <div>
                    <span className="font-bold text-white block">Mentorship by UK Alumni</span>
                    <span className="text-slate-400">Led by University of Derby engineering graduates.</span>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-2.5 rounded-lg bg-white/5 border border-white/5">
                  <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0 mt-0.5" />
                  <div>
                    <span className="font-bold text-white block">High-Frequency Testing</span>
                    <span className="text-slate-400">Chapter assessments and full mock simulations.</span>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-3 border-t border-slate-700/60 text-center">
                ...
                >
                  Request Batch Guidance & Counselling
                </a>
              </div>
            </div>
          </div>
