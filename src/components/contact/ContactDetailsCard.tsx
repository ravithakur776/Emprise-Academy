    ...
    <div className="space-y-6">
      ...
      <div className="rounded-3xl bg-white border border-slate-200 shadow-sm p-6 sm:p-8 space-y-6">
        <div className="border-b border-slate-100 pb-4">
          ...
          <p className="text-xs text-slate-500 mt-0.5">
            Central administrative and classroom facility in Mathura
          </p>
        </div>
        ...
        <div className="space-y-4 text-xs sm:text-sm text-slate-700">
          ...
          <div className="flex items-start gap-3.5">
            ...
            <div>
              ...
              <p className="text-slate-600">{contactDetails.address.fullAddress}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3.5">
            ...
            <div>
              <strong className="block text-slate-900 mb-0.5">Admissions & Reception</strong>
              <a
          ...
          <div className="flex items-start gap-3.5">
            ...
            <div>
              ...
              >
                {contactDetails.whatsapp} (Click to Chat)
              </a>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3.5">
            ...
            <div>
              ...
              <p className="text-slate-600">{contactDetails.workingHours}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-3xl bg-white border border-slate-200 shadow-sm p-4 sm:p-6 space-y-4">
        <div className="flex items-center justify-between">
          ...
          <a
            href={contactDetails.googleMapsDirectionsUrl}
            target="_blank"
            rel="noopener noreferrer"
