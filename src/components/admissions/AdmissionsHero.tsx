...
import { ArrowRight, Phone, ShieldCheck, CheckCircle2, Trophy, Sparkles } from "lucide-react";

export interface AdmissionsHeroProps {
    ...
    <section className="relative overflow-hidden bg-linear-to-b from-[var(--brand-primary)] via-[#0D2342] to-[#0A192F] text-white pt-6 pb-12 sm:pt-8 sm:pb-16 lg:pb-20 border-b border-slate-800">
      ...
      <Container size="xl" className="relative z-10 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          {/* Right Column: Admission Highlights Card */}
            ...
            <div className="rounded-2xl bg-linear-to-b from-slate-800/90 to-slate-900/95 border border-slate-700/80 p-6 sm:p-8 shadow-2xl backdrop-blur-md space-y-5">
              <div className="flex items-center gap-3 border-b border-slate-700/60 pb-4">
                ...
                <div>
                  <h3 className="text-sm font-bold text-white leading-tight">
                    Structured Admissions Journey
                  </h3>
                  <p className="text-[11px] text-slate-400">
                    IIT-JEE • NEET-UG • Foundation (8–10)
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-3 text-xs text-slate-300">
                <div className="flex items-start gap-2.5 p-2.5 rounded-lg bg-white/5 border border-white/5">
                  ...
                  <div>
                    <span className="font-bold text-white block">Free In-Person Academic Counselling</span>
                    <span className="text-slate-400">Honest academic stream and batch roadmap review.</span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2.5 p-2.5 rounded-lg bg-white/5 border border-white/5">
                  ...
                  <div>
                    <span className="font-bold text-white block">Transparent Fee Structure</span>
                    <span className="text-slate-400">Zero hidden costs with documented scholarship slabs.</span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2.5 p-2.5 rounded-lg bg-white/5 border border-white/5">
                  ...
                  <div>
                    <span className="font-bold text-white block">Direct Director Access</span>
                    <span className="text-slate-400">Founders teach and guide students directly in Mathura.</span>
                  </div>
                </div>
              </div>
