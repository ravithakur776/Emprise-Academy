...
export const AdmissionsFaqSection: React.FC = () => {
  const { faqs } = MAIN_ADMISSIONS_DATA;
      ...
      <Container size="md">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 space-y-3">
          ...
          <Text variant="body-large" color="muted" align="center">
            Helpful, transparent answers regarding batch commencement, documentation, and campus counselling.
          </Text>
        </div>
        ...
        <div className="text-center pt-8">
          ...
          >
            <span>Have more questions about admissions? Contact our campus desk directly</span>
