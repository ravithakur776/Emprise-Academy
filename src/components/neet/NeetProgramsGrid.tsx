...
import { NeetProgramCard } from "@/data/neet";
import { CheckCircle2, ArrowRight, Clock } from "lucide-react";
import { cn } from "@/lib/utils";

export interface NeetProgramsGridProps {
  programs: NeetProgramCard[];
}

export const NeetProgramsGrid: React.FC<NeetProgramsGridProps> = ({ programs }) => {
  return (
      ...
      <Container size="xl">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-3">
          <Badge variant="primary" size="md">
            STRUCTURED MEDICAL PATHWAYS
          </Badge>
          <Heading as="h2" variant="h1" align="center">
            NEET-UG Programmes at Emprise Academy
          </Heading>
          <Text variant="body-large" color="muted" align="center">
            Calibrated learning timelines designed for students entering Class 11, continuing in Class 12, or dedicating an intensive drop year toward medical admissions.
          </Text>
        </div>
