...
export interface NeetTestingSectionProps {
  heading?: string;
  subheading?: string;
...
export const NeetTestingSection: React.FC<NeetTestingSectionProps> = ({
  heading = "Test. Analyse. Improve.",
  subheading = "Our continuous medical assessment framework is calibrated to develop high-speed accuracy, eliminate negative marking, and build 3-hour exam endurance.",
  tiers,
}) => {
  return (
