...
import { NeetFaqItem } from "@/data/neet";
import { ChevronDown, ArrowRight } from "lucide-react";
import { cn } from "@/lib/utils";

export interface NeetFaqSectionProps {
  heading?: string;
  subheading?: string;
  faqs: readonly NeetFaqItem[];
}

export const NeetFaqSection: React.FC<NeetFaqSectionProps> = ({
  heading = "NEET-UG Frequently Asked Questions",
  subheading = "Clear, factual answers for students and parents exploring medical entrance coaching at Emprise Academy.",
  faqs,
}) => {
