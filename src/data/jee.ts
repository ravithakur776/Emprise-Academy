...
export const MAIN_JEE_DATA = {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Emprise Academy is located Near Tera Tower, Bhuteshwar Road, Mathura, Uttar Pradesh - 281004. Admissions counselling and batch orientations operate throughout the academic session.",
    },
  ] as JeeFaqItem[],
} as const;
