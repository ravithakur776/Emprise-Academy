...
-- Initial PostgreSQL Database Schema & Security Architecture
-- Phase 1 Production-Ready Migration
-- ==========================================================
...
-- ==========================================================
-- 8. ETSE 2026 & AUTOMATIC ADMIT CARDS
-- ==========================================================
...
-- Trigger: Automatically Generate Admit Card when ETSE Registration is created
...
BEGIN
    ...
    -- Format roll number: YEAR + 2-digit class + sequence
...
-- ==========================================================
-- 9. RESULT MANAGEMENT & STUDENT RESULT HISTORY
-- ==========================================================
...
-- Trigger: Automatically link result to student_result_history if student profile exists
...
-- ==========================================================
-- 10. SCHOLARSHIPS, CMS, GALLERY, BLOG & ANNOUNCEMENTS
-- ==========================================================
...
-- Public read policies for CMS content
...
-- Audit Log Policies (Super Admin Only)
...
-- ==========================================================
-- 14. SECURE RPC LOOKUP FUNCTIONS
-- ==========================================================

-- Public Admit Card Verification (reveals minimal information only)
...
BEGIN
    ...
    WHERE ac.verification_token = p_token
      AND ac.is_generated = TRUE;

    IF v_result IS NULL THEN
        RETURN jsonb_build_object('isValid', FALSE, 'message', 'Invalid or expired admit card verification token');
    END IF;
